...
irrelevant to this task. Your product manager takes a look at the files and immediately notices
that the data does not contain a timestamp, which is necessary for downstream processes.
...
# add logic below to generate new timestamp column named "ingestion_timestamp"