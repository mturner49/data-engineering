...
that your team, legally, can not consume. The file also contains data formatting issues that will lead to problems when you
ingest the files in your data warehouse

Instructions:
Using the csv file "data/pii_data.csv"
1. Write a method to exclude the PII columns (card_number, cvv)
